...
/**
 * @brief Inicializa una red Wi-Fi para que otros dispositivos se conecten al ESP32.
 *
 * @param ssid ssid del ESP32.
 * @param password password del ESP32.
 */
...
static void event_handler(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    ...
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_AP_STADISCONNECTED)
    {
        ...
        ESP_LOGI(TAG, "station " MACSTR " leave, AID=%" PRIu8, MAC2STR(event->mac), event->aid);
    }
